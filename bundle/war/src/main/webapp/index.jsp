...
.login_imgbg3{
	width:100%;
	height:38px;
	background:url(style/images/biap/login/login_bg.png);}
...
<!--body begin-->
<div class="login_box">
 <ul><img src="style/images/biap/login/login_s.gif"  border="0" /></ul>
 <ul>
  <div class="login_box_sign">
  <form action="biap/login.action" method="post" id="loginForm">
	 <ul class="sign100"><h1>登录</h1></ul>
     <ul class="sign100">
     	<li class="sign100 li14">登录账号：<input class="input" type="text" id="loginId" name="loginId"  value="" /></li>
     	<li class="sign100 li14">登录密码：<input class="input" id="loginPwd" name="loginPwd" type="password" value="" /></li>
...
<!-- body end-->
<!-- footer begin-->
<div class="login_footer">©2011 alibaba.com B2B数据门户版权所有</div>
<!-- footer end-->
</body>
</html>